...
const MANAGED_PLUGIN = { repository: 'https://github.com/happycastle114/opencode-litellm.git', revision: '5c816baec4cd89a053b7ffa54135f941f7c89ffb', checkoutDirectory: 'opencode-litellm-git', entrypoint: 'src/index.ts', remote: 'origin', packageLock: 'package-lock.json' } as const
